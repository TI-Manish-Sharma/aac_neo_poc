                ...
                <>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm">
                            ...
                            <h3 className="text-lg font-medium text-gray-600">Batches with Rejection (&gt;5%)</h3>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm">
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-lg font-medium text-gray-800">Top 5 Mould Boxes by Defect Rate</h3>
